...
const arrayLikeAtDirectIndexCore: ArrayLikeAtDirectIndexCore = <Index extends ArrayLikeIndex<X>, X extends ArrayLike<unknown>>(index: ToIndexDirect<Index>, { length }: X): Index | void => {
