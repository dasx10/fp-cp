	...
	describe('direct', () => {
		describe('array', () => {
			testArray.forEach((value, index) => {
				test(`has ${value}`, () => {
					const atValue = arrayLikeAtDef(index, testArray);
			...
			test('no has', () => {
				const atValue = arrayLikeAtDef(testArray.length, testArray);
				expect(atValue).toBeUndefined();
			});

			test('empty', () => {
				const atValue = arrayLikeAtDef(0, []);
				expect(atValue).toBeUndefined();
			});
		});
		...
		describe('chars', () => {
			for (let index = 0; index < testString.length; index++) {
				...
				test(`has ${char}`, () => {
					const atValue = arrayLikeAtDef(index, testString);
					expect(atValue).toBeDefined();
			...
			test('no has', () => {
				const atValue = arrayLikeAtDef(testString.length, testString);
				expect(atValue).toBeUndefined();
			});
		...
		instances.forEach(instance => {
			describe(instance.name, () => {
				...
				testTypedArray.forEach((value, index) => {
					test(`has ${value}`, () => {
						const atValue = arrayLikeAtDef(index, testTypedArray);
						expect(atValue).toBeDefined();
						expect(atValue).toBe(value);
					});
				});
				...
				test('no has', () => {
					const atValue = arrayLikeAtDef(testTypedArray.length, testTypedArray);
					expect(atValue).toBeUndefined();
				});

				test('empty', () => {
					const atValue = arrayLikeAtDef(0, new instance([]));
					expect(atValue).toBeUndefined();
				});
			});
		});
	...
	describe('direct', () => {
		describe('array', () => {
			testArray.forEach((_, index) => {
				...
				test(`has ${value}`, () => {
					const atValue = arrayLikeAtDef(invertIndex, testArray);
					expect(atValue).toBeDefined();
					expect(atValue).toBe(value);
				});
			});
			...
			test('empty', () => {
				const atValue = arrayLikeAtDef(-1, []);
				expect(atValue).toBeUndefined();
			});
		});
		...
		describe('chars', () => {
			for (let index = 0; index < testString.length; index++) {
				...
				test(`has ${char}`, () => {
					const atValue = arrayLikeAtDef(invertIndex, testString);
					expect(atValue).toBeDefined();
					expect(atValue).toBe(char);
				});
			}
		...
		instances.forEach(instance => {
			describe(instance.name, () => {
				...
				testTypedArray.forEach((_, index) => {
					...
					test(`has ${value}`, () => {
						const atValue = arrayLikeAtDef(invertIndex, testTypedArray);
						expect(atValue).toBeDefined();
						expect(atValue).toBe(value);
					});
				});
				...
				test('empty', () => {
					const atValue = arrayLikeAtDef(-1, new instance([]));
					expect(atValue).toBeUndefined();
				});
			});
		});
