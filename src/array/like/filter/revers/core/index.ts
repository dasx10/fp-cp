...
import type { ArrayLikeFilterReversCore }         from "./index.D";

const arrayLikeFilterReversCore = (<X extends ArrayLike<unknown> = ArrayLike<unknown>>(
...
}) as ArrayLikeFilterReversCore;

export default arrayLikeFilterReversCore;
