...
const arraySortCore = <X extends readonly any[]>(executor: (a: ArrayValue<X>, b: ArrayValue<X>) => any, array: X): Sort<X> => {
	const { length } = array;
	switch (length) {
		case 0: return [] as Sort<X>;
		case 1: return [array[0]] as Sort<X>;
		case 2: return (executor(array[0], array[1]) < 0 ? [array[0], array[1]] : [array[1], array[0]]) as Sort<X>;
		default: {
