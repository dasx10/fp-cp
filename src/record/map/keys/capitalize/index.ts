import capitalize, { ToCapitalize } from "../../../../string/case/capitalize/index";
import mapKeys from "../index";

type CapitalizeKeys<R extends Record<string, any>> = keyof R extends string ? {
  [key in ToCapitalize<keyof R>]: Uncapitalize<key> extends keyof R 
    ? R[Uncapitalize<key>]
    : R[Exclude<keyof R, Uncapitalize<ToCapitalize<keyof R>>>]
} : R;
